export { installRequireShim }
export { installRequireShim_setUserRootDir }

import { assert ,assertIsNotBrowser   ,assertPosixPath, getGlobalObject, isVitest, pathJoin, toPosixPath } from './utils.cjs'
...
function installRequireShim_setUserRootDir(userRootDir: string): void {
